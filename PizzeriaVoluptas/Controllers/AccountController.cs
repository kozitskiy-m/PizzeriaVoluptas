...
namespace PizzeriaVoluptas.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(PizzaVoluptasContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Login(LoginViewModel user)
        {
            ...
            if (foundUser == null)
            {
                ModelState.AddModelError("Email", "Simething wrong with email or password, try again");
                return View(user);
            }
            //------------
        ...
        public IActionResult RecoveryPassword(RecoveryPasswordViewModel recoveryPassword)
        {
            ...
            mail.From = new MailAddress("veresgatoki@gmail.com");
            mail.To.Add(foundUser.Email);
            mail.Subject = "Recovery code";
            mail.Body = "Your recovery code:" + foundUser.RecoveryCode;

            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("veresgatoki@gmail.com", "pqli ceel ciuj tbpp");
